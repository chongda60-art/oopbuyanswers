@{
  ...
  ExpectedGitRemote = 'https://github.com/chongda60-art/oopbuyanswers.git'
  VercelScope = 'chen-d2eb'
  VercelProject = 'oopbuyanswers'
  ApexDomain = 'oopbuyanswers.com'
  WwwDomain = 'www.oopbuyanswers.com'
